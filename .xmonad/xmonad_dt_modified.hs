...
myBrowser :: String
myBrowser = "brave-nighlty"  -- Sets qutebrowser as browser
...
myStartupHook = do
  ...
  --  spawnOnce "conky -c $HOME/.config/conky/xmonad.conkyrc"
    ...
    spawnOnce "nitrogen --restore &"   -- nitrogen 
    setWMName "LG3D"
...
myWorkspaces = def { workspaces  = withScreens 2  [" 1 ", " 2 ", " 3 ", " 4 ", " 5 ", " 6 ", " 7 ", " 8 ", " 9 "]  
...
myKeys =
    ...
    -- Toggle them to hide and it sends them back to hidden workspace (NSP).
        , ("C-s t", namedScratchpadAction myScratchPads "xfce4-terminal")
